# rotation — agent instructions

This is a [Spectrum](https://photon.codes/docs/spectrum-ts) app, pinned to `spectrum-ts@^5.0.0`. The entry point is `src/index.ts`, which configures the iMessage provider(s) and runs the echo loop.
