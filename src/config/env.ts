...
const defaultOpenRouterPlaylistModel = "anthropic/claude-sonnet-4.6";
...
const openRouterPlaylistModel =
  process.env.OPENROUTER_PLAYLIST_MODEL ?? defaultOpenRouterPlaylistModel;
